            ...
            <div class="row flex-row-reverse">
                ...
                <div class="col-xl-8 col-lg-7 col-12">
                    <div class="map-area">
                        <div class="maps">
                            <iframe
                                src="{{ $landingPageContent ? $landingPageContent->location_link : ' https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d63319.92695043451!2d79.91882435000002!3d6.9776795!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae256634982c6f7%3A0x4018010c1909b6aa!2sKadawatha!5e0!3m2!1sen!2slk!4v1711828854992' }}"
                    ...
                    <div class="contact-wrapper">
                        ...
                        <div class="contact-item">
                            ...
                            <div class="contact-content">
                                ...
                                <p>{{ $landingPageContent ? $landingPageContent->number_1 : ' 074 xxx xxxx' }} /
                                    {{ $landingPageContent ? $landingPageContent->number_2 : ' 070 xxx xxxx' }}</p>
                            </div>
                        </div>
                        <div class="contact-item">
                            <div class="contact-thumb">
                            ...
                            <div class="contact-content">
                                ...
                                <a
                                    href="mailto:xxx@gmail.com">{{ $landingPageContent ? $landingPageContent->email : 'xxx@gmail.com' }}</a>
                            </div>
                        </div>
                        <div class="contact-item">
                            <div class="contact-thumb">
